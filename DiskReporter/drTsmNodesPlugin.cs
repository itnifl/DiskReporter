      ...
      */
               ...
               where T2 : IComNode, new() 
      {
         ...
         foreach (Hashtable htable in hashtableList) {
            ...
            if (!currentException) {
                  using (var reader = System.Diagnostics.Debugger.IsAttached || externalDebug ? new StreamReader(GenerateStreamFromString("HUGO_S_APP03," +
                                                                                                                              "\\\\HUGO_S_APP03\\c$," +
                                                                                                                              "2502," +
                                                                                                                              "72," +
                                                                                                                              "2015-07-01 06:50:02.000301" +
                                                                                                                              System.Environment.NewLine +
                                                                                                                              "HUGO_W_DB02," +
                                                                                                                              "/," +
                                                                                                                              "16502," +
                                                                                                                              "80," +
                                                                                                                              "2015-07-01 02:50:02.000001" +
                                                                                                                              System.Environment.NewLine
                  ...
                  if (!reader.EndOfStream) {
            	      do {
                        ...
                        if (ourNode != null && !ourNode.Name.Equals("Noname")) {                          
                           ...
                           if (String.IsNullOrEmpty(nameFilter) || tsmProperties.NODE_NAME.Equals(nameFilter)) {
                              ourNode = new T2();
